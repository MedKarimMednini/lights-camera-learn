...
(globalThis.webpackChunk_websiteComponents = globalThis.webpackChunk_websiteComponents || []).push([
    [20293], {
        20293(t, e, n) {
            ...
            var o = n(10774);
            ! function() {
                if ("object" === ("undefined" == typeof window ? "undefined" : (0, o.A)(window)))
                    if ("IntersectionObserver" in window && "IntersectionObserverEntry" in window && "intersectionRatio" in window.IntersectionObserverEntry.prototype) "isIntersecting" in window.IntersectionObserverEntry.prototype || Object.defineProperty(window.IntersectionObserverEntry.prototype, "isIntersecting", {
                        ...
                        var t = function() {
                            ...
                            n = null,
                            i = null;
                        h.prototype.THROTTLE_TIMEOUT = 100, h.prototype.POLL_INTERVAL = null, h.prototype.USE_MUTATION_OBSERVER = !0, h._setupCrossOriginUpdater = function() {
                        ...
                        }, h._resetCrossOriginUpdater = function() {
                            n = null, i = null
                        }, h.prototype.observe = function(t) {
                        ...
                        }, h.prototype._initThresholds = function(t) {
                            var e = t || [0];
                            return Array.isArray(e) || (e = [e]), e.sort().filter(function(t, e, n) {
                                if ("number" != typeof t || isNaN(t) || t < 0 || t > 1) throw new Error("threshold must be a number between 0 and 1 inclusively");
                                return t !== n[e - 1]
                            })
                        }, h.prototype._parseRootMargin = function(t) {
                        ...
                        }, h.prototype._monitorIntersections = function(e) {
                            var n = e.defaultView;
                        ...
                        }, h.prototype._unmonitorIntersections = function(e) {
                        ...
                        }, h.prototype._unmonitorAllIntersections = function() {
                            var t = this._monitoringUnsubscribes.slice(0);
                            this._monitoringDocuments.length = 0, this._monitoringUnsubscribes.length = 0;
                            for (var e = 0; e < t.length; e++) t[e]()
                        }, h.prototype._checkForIntersections = function() {
                            if (this.root || !n || i) {
                                ...
                                this._observationTargets.forEach(function(o) {
                                    var i = o.element,
                                        ...
                                        u = o.entry,
                                        c = t && h && this._computeTargetAndRootIntersection(i, r, e),
                                        a = null;
                                    this._rootContainsTarget(i) ? n && !this.root || (a = e) : a = {
                                        top: 0,
                                        bottom: 0,
                                        left: 0,
                                        right: 0,
                                    ...
                                    u ? t && h ? this._hasCrossedThreshold(u, f) && this._queuedEntries.push(f) : u && u.isIntersecting && this._queuedEntries.push(f) : this._queuedEntries.push(f)
                                }, this), this._queuedEntries.length && this._callback(this.takeRecords(), this)
                            }
                        }, h.prototype._computeTargetAndRootIntersection = function(e, o, r) {
                            if ("none" != window.getComputedStyle(e).display) {
                                for (var s = o, h = g(e), u = !1; !u && h;) {
                                    var c = null,
                                        f = 1 == h.nodeType ? window.getComputedStyle(h) : {};
                                    if ("none" == f.display) return null;
                                    if (h == this.root || 9 == h.nodeType)
                                        if (u = !0, h == this.root || h == t) n && !this.root ? !i || 0 == i.width && 0 == i.height ? (h = null, c = null, s = null) : c = i : c = r;
                                        else {
                                            var d = g(h),
                                                m = d && l(d),
                                                _ = d && this._computeTargetAndRootIntersection(d, m, r);
                                            m && _ ? (h = d, c = p(m, _)) : (h = null, s = null)
                                        }
                                    else {
                                        var b = h.ownerDocument;
                                        h != b.body && h != b.documentElement && "visible" != f.overflow && (c = l(h))
                                    }
                                    if (c && (s = a(c, s)), !s) break;
                                    h = h && g(h)
                                }
                                return s
                            }
                        }, h.prototype._getRootRect = function() {
                            var e;
                        ...
                        }, h.prototype._expandRectByRootMargin = function(t) {
                        ...
                        }, h.prototype._hasCrossedThreshold = function(t, e) {
                        ...
                        }, h.prototype._rootIsInDom = function() {
                            return !this.root || d(t, this.root)
                        }, h.prototype._rootContainsTarget = function(e) {
                            var n = this.root && (this.root.ownerDocument || this.root) || t;
                            return d(n, e) && (!this.root || n == e.ownerDocument)
                        }, h.prototype._registerInstance = function() {
                            e.indexOf(this) < 0 && e.push(this)
                        }, h.prototype._unregisterInstance = function() {
                            var t = e.indexOf(this); - 1 != t && e.splice(t, 1)
                        }, window.IntersectionObserver = h, window.IntersectionObserverEntry = s
                    }
                function r(t) {
                    try {
